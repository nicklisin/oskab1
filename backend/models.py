...
class Offer(models.Model):
    ...
    price = models.PositiveIntegerField(default='', verbose_name='Цена')
    ...
    delivery_range_price = models.PositiveSmallIntegerField(default=0, verbose_name='Стоимость доставки, руб/км', null=True, blank=True)
