...
class Help extends Component {
    ...
    return (
        ...
        <p><NavLink to='/help/legal'>Условия оказания услуг Пользователям Сайта oskab.ru</NavLink> (редакция от 07.05.22)</p>
